...
export const StaffAccounts: React.FC<StaffAccountsProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Button onClick={() => onNavigate('add-new-staff')} className="bg-gradient-primary">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card className="quick-action-button hover:shadow-lg transition-all cursor-pointer" onClick={() => onNavigate('add-new-staff')}>
        ...
        <Card className="quick-action-button hover:shadow-lg transition-all cursor-pointer" onClick={() => onNavigate('manage-staff')}>
          <CardContent className="p-6">
            <div className="flex items-center space-x-4">
