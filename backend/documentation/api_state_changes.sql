...
SELECT order_id, assigned_driver_id, order_status FROM Orders WHERE order_id = 2;
...
SELECT restaurant_id, status FROM Restaurant WHERE restaurant_id = 5;
