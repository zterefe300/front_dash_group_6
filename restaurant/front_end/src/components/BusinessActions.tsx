    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h4 className="mb-3">Regular Support</h4>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Manage your partnership status and access important documents</CardDescription>
        </CardHeader>
